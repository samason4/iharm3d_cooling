...
# python3 ./script/analysis/cooling/theta_plots.py -p ./script/analysis/cooling/theta_params.dat
...
def analysis_torus2d(dumpval, cmap='jet', vmin=-6, vmax=-2.5, domain = [-50,0,-50,50], bh=True, shading='gouraud'):
    plt.clf()
    ...
    theta0 = np.log10((game-1.)*uel0/rho)
    theta1 = np.log10((game-1.)*uel1/rho)
    theta2 = np.log10((game-1.)*uel2/rho)
    theta3 = np.log10((game-1.)*uel3/rho)
    t = dfile['t'][()]
    dfile.close()
    t = "{:.3f}".format(t)
...
#**********************************************************************************************************************
    ...
    theta02 = np.log10((game2-1.)*uel02/rho2)
    theta12 = np.log10((game2-1.)*uel12/rho2)
    theta22 = np.log10((game2-1.)*uel22/rho2)
    theta32 = np.log10((game2-1.)*uel32/rho2)
    t2 = dfile2['t'][()]
    dfile2.close()
    t2 = "{:.3f}".format(t2)
    ...
    ax1.set_title('log(Theta) w/ KEL0; Heating',fontsize='large')
    if bh:
    ...
    ax2.set_title('log(Theta) w/ KEL1; Heating',fontsize='large')
    if bh:
            circle = plt.Circle((0,0),grid['rEH'],color='k')
    ...
    ax3.set_title('log(Theta) w/ KEL2; Heating',fontsize='large')
    if bh:
            circle = plt.Circle((0,0),grid['rEH'],color='k')
    ...
    ax4.set_title('log(Theta) w/ KEL3; Heating',fontsize='large')
    if bh:
            circle = plt.Circle((0,0),grid['rEH'],color='k')
    ...
    ax5.set_title('log(Theta) w/ KEL0; Heating & Cooling',fontsize='large')
    if bh:
            circle = plt.Circle((0,0),grid['rEH'],color='k')
    ...
    ax6.set_title('log(Theta) w/ KEL1; Heating & Cooling',fontsize='large')
    if bh:
            circle = plt.Circle((0,0),grid['rEH'],color='k')
    ...
    ax7.set_title('log(Theta) w/ KEL2; Heating & Cooling',fontsize='large')
    if bh:
            circle = plt.Circle((0,0),grid['rEH'],color='k')
    ...
    ax8.set_title('log(Theta) w/ KEL3; Heating & Cooling',fontsize='large')
    if bh:
            circle = plt.Circle((0,0),grid['rEH'],color='k')
